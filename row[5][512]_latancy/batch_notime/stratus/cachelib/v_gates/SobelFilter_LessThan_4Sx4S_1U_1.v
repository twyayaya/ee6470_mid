...
// Generated on: May  6 2021 02:30:33 CST (May  5 2021 18:30:33 UTC)

module SobelFilter_LessThan_4Sx4S_1U_1(in2, in1, out1);
  input [3:0] in2, in1;
  output out1;
  wire [3:0] in2, in1;
  wire out1;
  ...
  NAND2X1 gt_21_53_g152(.A (gt_21_53_n_7), .B (gt_21_53_n_9), .Y
       (gt_21_53_n_12));
  NAND2X1 gt_21_53_g153(.A (gt_21_53_n_7), .B (gt_21_53_n_10), .Y
       (gt_21_53_n_11));
  NOR2X1 gt_21_53_g154(.A (gt_21_53_n_3), .B (in1[2]), .Y
       (gt_21_53_n_10));
  NAND2X1 gt_21_53_g155(.A (in1[2]), .B (gt_21_53_n_3), .Y
       (gt_21_53_n_9));
  INVX2 gt_21_53_g157(.A (gt_21_53_n_8), .Y (gt_21_53_n_7));
  NOR2X6 gt_21_53_g158(.A (in2[3]), .B (gt_21_53_n_2), .Y
       (gt_21_53_n_8));
  NOR2X1 gt_21_53_g159(.A (gt_21_53_n_1), .B (in1[1]), .Y
       (gt_21_53_n_6));
  NAND2X1 gt_21_53_g160(.A (in1[1]), .B (gt_21_53_n_1), .Y
       (gt_21_53_n_5));
  NAND2X1 gt_21_53_g161(.A (in2[3]), .B (gt_21_53_n_2), .Y
       (gt_21_53_n_4));
  INVX1 gt_21_53_g162(.A (in2[2]), .Y (gt_21_53_n_3));
  CLKINVX16 gt_21_53_g164(.A (in1[3]), .Y (gt_21_53_n_2));
  INVX1 gt_21_53_g165(.A (in2[1]), .Y (gt_21_53_n_1));
