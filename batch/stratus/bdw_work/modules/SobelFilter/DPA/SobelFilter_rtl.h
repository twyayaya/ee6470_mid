...
struct SobelFilter : public sc_module {
  ...
  sc_signal<sc_uint<1> > SobelFilter_gen_busy_r_4_61_gdiv;
  sc_signal<sc_uint<1> > SobelFilter_gen_busy_r_4_61_gnew_req;
  sc_signal<sc_uint<5> > global_state_next;
  sc_signal<sc_uint<9> > SobelFilter_gen000001_4_43_in1;
  sc_signal<sc_uint<1> > gs_ctrl19;
  sc_signal<sc_int<8> > SobelFilter_Add2Mul2s8u8s8_4_30_in3;
  sc_signal<sc_uint<2> > gs_ctrl18;
  sc_signal<sc_uint<8> > SobelFilter_Div_8U_27_4_29_out1;
  ...
  sc_signal<sc_uint<1> > SobelFilter_Lti2s3_4_15_out1;
  ...
  sc_signal<sc_uint<11> > SobelFilter_gen000001_4_43_out1;
  sc_signal<sc_uint<11> > SobelFilter_Add2iLLu9_4_53_out1;
  sc_signal<sc_uint<11> > SobelFilter_gen000001_4_49_out1;
  sc_signal<sc_uint<8> > s_reg_45;
  sc_signal<sc_uint<8> > s_reg_44;
  sc_signal<sc_uint<8> > s_reg_42;
  sc_signal<sc_uint<8> > s_reg_41;
  sc_signal<sc_uint<2> > SobelFilter_Add2i1u2_4_26_out1;
  sc_signal<sc_uint<2> > s_reg_40;
  sc_signal<sc_uint<2> > SobelFilter_Add2i1u2_4_25_out1;
  sc_signal<sc_int<3> > SobelFilter_Add2i1u1_4_12_out1;
  ...
  sc_signal<sc_uint<3> > s_reg_39;
  sc_signal<sc_uint<1> > SobelFilter_LtiLLs11_4_14_out1;
  sc_signal<sc_uint<2> > s_reg_37_slice;
  sc_signal<sc_uint<3> > SobelFilter_gen_busy_r_4_61_out1;
  sc_signal<sc_uint<1> > SobelFilter_And_1Ux1U_1U_4_57_out1;
  sc_signal<sc_uint<1> > SobelFilter_And_1Ux1U_1U_4_58_out1;
  sc_signal<sc_uint<1> > SobelFilter_And_1Ux1U_1U_4_59_out1;
  ...
  sc_signal<sc_uint<1> > SobelFilter_LtiLLs11_4_56_out1;
  ...
  void drive_s_reg_44();
  void drive_s_reg_45();
  void SobelFilter_Add2i1u1_4_12();
  ...
  void SobelFilter_Add2i1u2_4_25();
  void SobelFilter_Add2i1u2_4_26();
  ...
  void SobelFilter_Div_8U_27_4_29();
  ...
  void drive_SobelFilter_gen000001_4_43_in1();
  void SobelFilter_gen000001_4_43();
  void SobelFilter_Add2iLLu9_4_53();
  void SobelFilter_gen000001_4_49();
  void SobelFilter_LtiLLs11_4_56();
  ...
  void SobelFilter_gen_busy_r_4_61_p8();
  void SobelFilter_gen_busy_r_4_61_p7();
  void SobelFilter_gen_busy_r_4_61_p6();
  void SobelFilter_gen_busy_r_4_61_p5();
  ...
  void SobelFilter_And_1Ux1U_1U_4_57();
  ...
  void SobelFilter_And_1Ux1U_1U_4_58();
  ...
  void SobelFilter_And_1Ux1U_1U_4_59();
