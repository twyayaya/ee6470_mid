...
module SobelFilter(i_clk, i_rst, i_rgb_busy, i_rgb_vld, i_rgb_data, o_result_r_busy, o_result_r_vld, o_result_r_data, o_result_g_busy, o_result_g_vld, o_result_g_data, o_result_b_busy, o_result_b_vld, o_result_b_data);
      ...
      reg[1:0] gs_ctrl19;
      wire[7:0] SobelFilter_Div_8U_28_4_29_out1;
      ...
      wire[10:0] SobelFilter_gen000001_4_56_out1;
      wire[10:0] SobelFilter_gen000002_4_49_out1;
      wire[10:0] SobelFilter_Add2iLLu9_4_61_out1;
      reg[3:0] gs_ctrl1;
      reg[1:0] SobelFilter_Add2i1u2_4_12_in1;
      reg gs_ctrl0;
      reg[7:0] s_reg_45;
      reg[7:0] s_reg_44;
      wire[1:0] SobelFilter_Add_2U_10_4_25_out1;
      reg[7:0] s_reg_41;
      reg[7:0] s_reg_40;
      wire[1:0] SobelFilter_Add_2U_10_4_26_out1;
      reg[1:0] s_reg_39;
      reg[1:0] s_reg_43;
      ...
      wire[7:0] from_tb_r_out1;
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd02:                      begin
                        if (s_reg_38[0]) begin
                           o_result_g_data <= {{ 4 {o_result_g_data[3]}}, o_result_g_data[3:0]};
                        end
                        else begin
                           if (SobelFilter_Lti3s4_4_15_out1) begin
                              o_result_g_data <= {{ 4 {SobelFilter_Add2i1u2_4_12_out1[3]}}, SobelFilter_Add2i1u2_4_12_out1};
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd01, 5'd03, 5'd21:                      begin
                        s_reg_37 <= SobelFilter_Add2i1u9_4_13_out1;
                     end
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd01:                      begin
                        s_reg_38 <= {1'b0, SobelFilter_LtiLLs11_4_14_out1};
                     end
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd06:                      begin
                        s_reg_39 <= SobelFilter_Add_2U_10_4_26_out1;
                     end
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd06:                      begin
                        s_reg_42 <= SobelFilter_Add2i1u9_4_13_out1;
                     end
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd06:                      begin
                        s_reg_43 <= SobelFilter_Add_2U_10_4_25_out1;
                     end
         ...
         // resource: mux_2bx2i1c
         always @(o_result_g_data[1:0] or gs_ctrl0)
          begin :drive_SobelFilter_Add2i1u2_4_12_in1
            if (gs_ctrl0) begin
               SobelFilter_Add2i1u2_4_12_in1 = o_result_g_data[1:0];
            end
            else begin
               SobelFilter_Add2i1u2_4_12_in1 = 2'd0;
            end
         end

         // resource: SobelFilter_Add2i1u2_4  instance: SobelFilter_Add2i1u2_4_12
         assign SobelFilter_Add2i1u2_4_12_out1 = {2'b00, SobelFilter_Add2i1u2_4_12_in1} + 4'd01;

         // resource: SobelFilter_Add2i1u9_4  instance: SobelFilter_Add2i1u9_4_13
         assign SobelFilter_Add2i1u9_4_13_out1 = {2'b00, s_reg_37[8:0]} + 11'd0001;

         // resource: SobelFilter_LtiLLs11_4  instance: SobelFilter_LtiLLs11_4_14
         assign SobelFilter_LtiLLs11_4_14_out1 = SobelFilter_Add2i1u9_4_13_out1[10] ^ SobelFilter_Add2i1u9_4_13_out1 < 11'd0512;

         // resource: mux_11bx8i0c
         always @(o_result_b_data[1:0] or s_reg_37[8:0] or SobelFilter_Add2iLLu9_4_18_out1 or SobelFilter_Add3u9u2Cati0u2_4_21_out1 or SobelFilter_LtiLLs11_4_42_out1 or SobelFilter_gen000002_4_43_out1 or SobelFilter_gen000001_4_56_out1 or SobelFilter_gen000002_4_49_out1 or SobelFilter_Add2iLLu9_4_61_out1 or gs_ctrl1)
          begin :drive_from_tb_r_in1
            case (gs_ctrl1) 
               ...
               4'd04:                begin
                  from_tb_r_in1 = {2'b00, s_reg_37[8:0]};
               end
               
               4'd05:                begin
                  from_tb_r_in1 = SobelFilter_gen000001_4_56_out1;
               end
               ...
               4'd07:                begin
                  from_tb_r_in1 = SobelFilter_Add2iLLu9_4_61_out1;
               end
               ...
               default:                begin
                  from_tb_r_in1 = {o_result_b_data[1:0], s_reg_37[8:0]};
               end
         ...
         // resource: mux_1bx2i2c
         always @(stall0 or SobelFilter_LtiLLs11_4_20_out1 or SobelFilter_Lti3u2_4_34_out1 or SobelFilter_Lti3u2_4_38_out1 or SobelFilter_LtiLLs11_4_62_out1 or gs_ctrl3)
         ...
         // resource: mux_11bx8i0c
         always @(o_result_b_data[1:0] or s_reg_37[8:0] or SobelFilter_Add2iLLu9_4_18_out1 or SobelFilter_Add3u9u2Cati0u2_4_21_out1 or SobelFilter_gen000002_4_43_out1 or SobelFilter_gen000001_4_56_out1 or SobelFilter_gen000002_4_49_out1 or SobelFilter_Add2iLLu9_4_61_out1 or gs_ctrl5)
          begin :drive_from_tb_g_in1
            case (gs_ctrl5) 
               ...
               3'd4:                begin
                  from_tb_g_in1 = {2'b00, s_reg_37[8:0]};
               end
               
               3'd5:                begin
                  from_tb_g_in1 = SobelFilter_gen000001_4_56_out1;
               end
               ...
               3'd7:                begin
                  from_tb_g_in1 = SobelFilter_Add2iLLu9_4_61_out1;
               end
               
               default:                begin
                  from_tb_g_in1 = {o_result_b_data[1:0], s_reg_37[8:0]};
               end
         ...
         // resource: mux_1bx2i2c
         always @(stall0 or SobelFilter_LtiLLs11_4_42_out1 or SobelFilter_LtiLLs11_4_62_out1 or gs_ctrl7)
         ...
         // resource: mux_11bx8i0c
         always @(o_result_b_data[1:0] or s_reg_37[8:0] or SobelFilter_Add2iLLu9_4_18_out1 or SobelFilter_Add3u9u2Cati0u2_4_21_out1 or SobelFilter_gen000002_4_43_out1 or SobelFilter_gen000001_4_56_out1 or SobelFilter_gen000002_4_49_out1 or SobelFilter_Add2iLLu9_4_61_out1 or gs_ctrl9)
          begin :drive_from_tb_b_in1
            case (gs_ctrl9) 
               ...
               3'd4:                begin
                  from_tb_b_in1 = {2'b00, s_reg_37[8:0]};
               end
               
               3'd5:                begin
                  from_tb_b_in1 = SobelFilter_gen000001_4_56_out1;
               end
               ...
               3'd7:                begin
                  from_tb_b_in1 = SobelFilter_Add2iLLu9_4_61_out1;
               end
               
               default:                begin
                  from_tb_b_in1 = {o_result_b_data[1:0], s_reg_37[8:0]};
               end
         ...
         // resource: mux_1bx2i2c
         always @(stall0 or SobelFilter_LtiLLs11_4_42_out1 or SobelFilter_LtiLLs11_4_62_out1 or gs_ctrl11)
         ...
         assign SobelFilter_Add2iLLu9_4_18_out1 = {2'b00, s_reg_37[8:0]} + 11'd1536;

         // resource: SobelFilter_LtiLLs11_4  instance: SobelFilter_LtiLLs11_4_20
         assign SobelFilter_LtiLLs11_4_20_out1 = s_reg_37[10] ^ s_reg_37 < 11'd0512;

         // resource: mux_2bx3i1c
         always @(s_reg_38 or s_reg_43 or SobelFilter_Lti3u2_4_34_out1 or gs_ctrl13)
          begin :drive_SobelFilter_Add3u9u2Cati0u2_4_21_in3
            case (gs_ctrl13) 

               2'd1:                begin
                  SobelFilter_Add3u9u2Cati0u2_4_21_in3 = s_reg_38;
               end
               ...
               2'd2:                begin
                  if (SobelFilter_Lti3u2_4_34_out1) begin
                     ...
                     SobelFilter_Add3u9u2Cati0u2_4_21_in3 = s_reg_43;
                  end
               end
         ...
         // resource: mux_2bx2i1c
         always @(s_reg_39 or SobelFilter_Lti3u2_4_34_out1 or gs_ctrl13)
          begin :drive_SobelFilter_Add3u9u2Cati0u2_4_21_in2
            case (gs_ctrl13) 

               2'd1:                begin
                  SobelFilter_Add3u9u2Cati0u2_4_21_in2 = s_reg_39;
               end
         ...
         always @(s_reg_37[8:0] or s_reg_42[8:0] or gs_ctrl15)
          begin :drive_SobelFilter_Add3u9u2Cati0u2_4_21_in1
            case (gs_ctrl15) 

               2'd1:                begin
                  SobelFilter_Add3u9u2Cati0u2_4_21_in1 = s_reg_37[8:0];
               end
               
               2'd2:                begin
                  SobelFilter_Add3u9u2Cati0u2_4_21_in1 = s_reg_42[8:0];
               end
         ...
         // resource: mux_2bx3i1c
         always @(s_reg_38 or s_reg_43 or SobelFilter_Lti3u2_4_34_out1 or gs_ctrl16)
          begin :drive_SobelFilter_Add2u2Mul2i3u2_4_22_in2
            if (gs_ctrl16) begin
               if (SobelFilter_Lti3u2_4_34_out1) begin
                  SobelFilter_Add2u2Mul2i3u2_4_22_in2 = s_reg_38;
               end
               else begin
                  SobelFilter_Add2u2Mul2i3u2_4_22_in2 = s_reg_43;
               end
            end
            else begin
         ...
         // resource: mux_2bx2i1c
         always @(s_reg_39 or SobelFilter_Lti3u2_4_34_out1 or gs_ctrl16)
          begin :drive_SobelFilter_Add2u2Mul2i3u2_4_22_in1
            if (gs_ctrl16) begin
               if (SobelFilter_Lti3u2_4_34_out1) begin
                  SobelFilter_Add2u2Mul2i3u2_4_22_in1 = s_reg_39;
               end
               else begin
         ...
         assign SobelFilter_Add_2U_10_4_25_out1 = s_reg_38 + 2'd1;

         // resource: SobelFilter_Add_2U_10_4  instance: SobelFilter_Add_2U_10_4_26
         assign SobelFilter_Add_2U_10_4_26_out1 = s_reg_39 + 2'd1;

         // resource: mux_8bx2i0c
         always @(s_reg_45 or from_tb_b_out1 or gs_ctrl18)
         ...
         assign bits_001 = {11'b00000000000, s_reg_40}*19'd000299 + {11'b00000000000, s_reg_44}*19'd000587 + {11'b00000000000, SobelFilter_R18_3Add3Mul2i144u8Mul2iLLu8Mul2i299u8_4_28_in1}*19'd000144;
         ...
         assign SobelFilter_Div_8U_28_4_29_out1 = SobelFilter_R18_3Add3Mul2i144u8Mul2iLLu8Mul2i299u8_4_28_out1 / 7'd125;

         // resource: mux_8bx3i0c
         always @(o_result_b_data or o_result_g_data or o_result_r_data or gs_ctrl19)
         ...
         assign SobelFilter_Add2Mul2s8u8s8_4_30_out1 = SobelFilter_Add2Mul2s8u8s8_4_30_in3 + SobelFilter_Div_8U_28_4_29_out1*s_reg_41;

         // resource: SobelFilter_Lti3u2_4  instance: SobelFilter_Lti3u2_4_34
         assign SobelFilter_Lti3u2_4_34_out1 = s_reg_39 < 2'd3;

         // resource: SobelFilter_Lti3u2_4  instance: SobelFilter_Lti3u2_4_38
         assign SobelFilter_Lti3u2_4_38_out1 = s_reg_43 < 2'd3;
         ...
         assign SobelFilter_LtiLLs11_4_42_out1 = s_reg_42[10] ^ s_reg_42 < 11'd0512;

         // resource: mux_9bx2i1c
         always @(s_reg_37[8:0] or gs_ctrl20)
          begin :drive_SobelFilter_gen000002_4_43_in1
            if (gs_ctrl20) begin
               SobelFilter_gen000002_4_43_in1 = s_reg_37[8:0];
            end
            else begin
         ...
         assign SobelFilter_gen000001_4_56_out1 = {2'b00, s_reg_37[8:0]} + 11'd1024;

         // resource: SobelFilter_gen000002_4  instance: SobelFilter_gen000002_4_49
         assign SobelFilter_gen000002_4_49_out1 = {2'b00, s_reg_37[8:0]} + 11'd0512;

         // resource: SobelFilter_Add2iLLu9_4  instance: SobelFilter_Add2iLLu9_4_61
         assign SobelFilter_Add2iLLu9_4_61_out1 = {2'b00, s_reg_37[8:0]} + 11'd1536;

         // resource: SobelFilter_LtiLLs11_4  instance: SobelFilter_LtiLLs11_4_62
         assign SobelFilter_LtiLLs11_4_62_out1 = s_reg_37[10] ^ s_reg_37 < 11'd0512;
         ...
         always @(s_reg_38[0] or SobelFilter_Lti3s4_4_15_out1 or SobelFilter_LtiLLs11_4_20_out1 or SobelFilter_Lti3u2_4_34_out1 or SobelFilter_Lti3u2_4_38_out1 or SobelFilter_LtiLLs11_4_42_out1 or SobelFilter_LtiLLs11_4_62_out1 or global_state)
               ...
               case (stall0) 
                  ...
                  1'b0:                   begin
                     case (global_state_next) 
                        ...
                        5'd01, 5'd03, 5'd15, 5'd16, 5'd17, 5'd18, 5'd19, 5'd20, 5'd21:                         begin
                           gs_ctrl3 <= 3'd1;
                        end
               ...
               case (stall0) 
                  ...
                  1'b0:                   begin
                     case (global_state_next) 
                        ...
                        5'd01, 5'd03, 5'd16, 5'd18, 5'd20, 5'd21:                         begin
                           gs_ctrl4 <= 1'b1;
                        end
               ...
               case (stall0) 
                  ...
                  1'b0:                   begin
                     case (global_state_next) 
                        ...
                        5'd01, 5'd03, 5'd05, 5'd16, 5'd17, 5'd18, 5'd19, 5'd20, 5'd21:                         begin
                           gs_ctrl7 <= 2'd1;
                        end
               ...
               case (stall0) 
                  ...
                  1'b0:                   begin
                     case (global_state_next) 
                        ...
                        5'd01, 5'd03, 5'd06, 5'd16, 5'd17, 5'd18, 5'd19, 5'd20, 5'd21:                         begin
                           gs_ctrl11 <= 2'd1;
                        end
