        ...
        //Gray = (from_tb_r * 299 + from_tb_g * 587 + from_tb_b * 144)/1000;
				{
					HLS_CONSTRAIN_LATENCY(0, 1, "lat01");
                                   //
          //Gray = (from_tb_r * 299 + from_tb_g * 587 + from_tb_b * 144)/1000;                         
          R += (sc_uint<32>)((from_tb_r * 299 + from_tb_g * 587 + from_tb_b * 144)/1000) * filter2[v][u];
					G += (sc_uint<32>)((from_tb_r * 299 + from_tb_g * 587 + from_tb_b * 144)/1000) * filter2[v][u];
					B += (sc_uint<32>)((from_tb_r * 299 + from_tb_g * 587 + from_tb_b * 144)/1000) * filter2[v][u];
            //origin
...
#endif
    //time
    T_end_time = sc_time_stamp();
    total_time = start_time - T_end_time ;
    //time
	}
}
